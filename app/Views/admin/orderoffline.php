  ...
  <div class="col-xl-12 col-md-12">
    <div class="card mb-1">
      <div class="card-header pb-0">
        <a class="text-decoration-none" href="<?= base_url('/orderoffline/masuk') ?>">
            ...
            <tbody>
              <?php foreach ($masuk as $d) : ?>
                <tr>
                  ...
                  <td>
                    <p class="text-xs text-wrap font-weight-bold text-uppercase mb-0"><?= $d['nama_barang'] ?></p>
                    <p class="text-xs text-secondary text-uppercase mb-0"><?= $d['jumlah_barang'] ?> <?= $d['dimensi_barang'] ?></p>
                  </td>
