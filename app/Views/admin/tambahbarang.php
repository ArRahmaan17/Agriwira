  ...
  <div class="p-5 col-xl-12 col-md-12">
    <div class="card mb-1">
      ...
      <div class="card-body px-5 pt-3 pb-2">
        ...
        <form action="<?= base_url('Admin/tambahbarang') ?>" class="col-12 mr-3" method="POST">
          <? csrf_field() ?>
          <div class="mb-1">
            <label for="nama_barang" class="form-label">Nama Barang</label>
            <input type="text" class="form-control" name="nama_barang" value="<?= (old('nama_barang')) ? old('nama_barang') : ''; ?>">
          </div>
          <div class="mb-1">
          ...
          <div class="d-flex">
            ...
            <div class="m-1 col-3">
              ...
              <select class="form-select" name="kemasan_barang">
                 <option <?= (old('kemasan_barang') == 'vakum') ? 'selected' : ''; ?> value="vakum">Vakum</option>
                 <option <?= (old('kemasan_barang') == 'curah') ? 'selected' : ''; ?> value="curah">Curah</option>
              </select>
            </div>
            <div class="m-1 col-3">
              <label for="expired_barang" class="form-label">Expired Barang</label>
              <select class="form-select" name="expired_barang">
                 <option <?= (old('expired_barang') == '6') ? 'selected' : ''; ?> value="6">6 Bulan</option>
                 <option <?= (old('expired_barang') == '12') ? 'selected' : ''; ?> value="12">12 Bulan</option>
                 <option <?= (old('expired_barang') == '18') ? 'selected' : ''; ?> value="18">18 Bulan</option>
              </select>
            </div>
          </div>
          <div class="my-4">
            <input type="submit" class="btn btn-primary form-control" value="Tambah Barang">
          </div>
        </form>
      </div>
    </div>
